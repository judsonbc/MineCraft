...
window.addEventListener('load', function() {
  ...
  if (false) {
    game_ref = new iScroll('game_scroller',{bounce:false, zoom:true});
    game.refresh=function(){setTimeout(game_ref.refresh(),100)};
    NSB.addProperties(game,game_scroller)}
  else NSB.addProperties(game);
